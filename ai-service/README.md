...
cassée, au lieu de pourrir silencieusement côté IA. Postgres ne joint pas
entre bases : les croisements scoring×exam se font ici, en Python.
...
2. Les migrations V20 (scoring) / V10 (exam) posent vues + GRANT au premier
   démarrage des services — elles échouent avec un message clair si le rôle
   n'existe pas encore (l'ordre 1 → 2 est obligatoire).
